...
public class SeekCityByListIPResponse  implements java.io.Serializable {
    private com.tcy365.externalService.ipas.IPAresInfo[] seekCityByListIPResult;

    public SeekCityByListIPResponse() {
    }

    public SeekCityByListIPResponse(
           com.tcy365.externalService.ipas.IPAresInfo[] seekCityByListIPResult) {
     ...
     */
    public com.tcy365.externalService.ipas.IPAresInfo[] getSeekCityByListIPResult() {
        return seekCityByListIPResult;
    }
     ...
     */
    public void setSeekCityByListIPResult(com.tcy365.externalService.ipas.IPAresInfo[] seekCityByListIPResult) {
        this.seekCityByListIPResult = seekCityByListIPResult;
    }
