...
public class SeekCityByIpsResponse  implements java.io.Serializable {
    private com.tcy365.externalService.ipas.IPAresInfo[] seekCityByIpsResult;

    public SeekCityByIpsResponse() {
    }

    public SeekCityByIpsResponse(
           com.tcy365.externalService.ipas.IPAresInfo[] seekCityByIpsResult) {
     ...
     */
    public com.tcy365.externalService.ipas.IPAresInfo[] getSeekCityByIpsResult() {
        return seekCityByIpsResult;
    }
     ...
     */
    public void setSeekCityByIpsResult(com.tcy365.externalService.ipas.IPAresInfo[] seekCityByIpsResult) {
        this.seekCityByIpsResult = seekCityByIpsResult;
    }
