...
public class GetAllAreaDataResponse  implements java.io.Serializable {
    private com.tcy365.externalService.ipas.GetAllAreaDataResponseGetAllAreaDataResult getAllAreaDataResult;

    public GetAllAreaDataResponse() {
    }

    public GetAllAreaDataResponse(
           com.tcy365.externalService.ipas.GetAllAreaDataResponseGetAllAreaDataResult getAllAreaDataResult) {
     ...
     */
    public com.tcy365.externalService.ipas.GetAllAreaDataResponseGetAllAreaDataResult getGetAllAreaDataResult() {
        return getAllAreaDataResult;
    }
     ...
     */
    public void setGetAllAreaDataResult(com.tcy365.externalService.ipas.GetAllAreaDataResponseGetAllAreaDataResult getAllAreaDataResult) {
        this.getAllAreaDataResult = getAllAreaDataResult;
    }
